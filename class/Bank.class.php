...
class Bank {
    ...
    public function bankInfo($card) {
        ...
        if (isset($this->bankList[$card_6])) {
            echo $this->bankList[$card_6];
            return;
        }
        $card_5 = substr($card, 0, 5);
        if (isset($this->bankList[$card_5])) {
            echo $this->bankList[$card_5];
            return;
        }
        $card_4 = substr($card, 0, 4);
        if (isset($this->bankList[$card_4])) {
            echo $this->bankList[$card_4];
            return;
        }
        echo '该卡号信息暂未录入';
    }
...
$bank = new bank();
$bank->bankInfo('5324582111575275');